...
#   ./set-origin.sh alexhcl/appscan360-gitlab [v1]
...
sed -i -E "s#https://raw\.githubusercontent\.com/[^/]+/appscan360-gitlab/[^/]+#$raw#g; s#https://github\.com/[^/]+/appscan360-gitlab\.git#$clone#g; s#(APPSCAN_SCRIPTS_GIT_REF: \")[^\"]*#\1$ref#g" "${files[@]}"
