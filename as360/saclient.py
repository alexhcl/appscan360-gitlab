...
def install_saclient(client: AS360Client, install_dir: Path | None = None, tool_type: str = "Linux") -> str:
    ...
    _extract_with_permissions(zip_path, tmp)
...
def _extract_with_permissions(zip_path: Path, dest: Path) -> None:
    """Extract a zip and restore Unix permission bits stored in each entry's external attributes."""
